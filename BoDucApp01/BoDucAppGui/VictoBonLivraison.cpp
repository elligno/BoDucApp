...
// information
void bdGui::VictoBonLivraison::fillBoDucFields( const std::vector<std::string>& aCmdVec, 
...
void bdGui::VictoBonLivraison::addBoDucField(const BoDucFields & aField2Add)
{
	m_vecOfStruct.push_back(aField2Add);
}

bool bdGui::VictoBonLivraison::containsBoDucField(const BoDucFields & aField2Look)
{
	// check for a specific field with given values
	return false;
}

bool bdGui::VictoBonLivraison::removeBoDucField(const BoDucFields & aField2)
{
	return false;
}

void bdGui::VictoBonLivraison::getBoDucStruct( std::vector<BoDucFields>& aVec2Fill)
{
